...
public class netherStarChestplate extends ItemArmor{
	...
	public netherStarChestplate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
		...
		setMaxStackSize(1);
		setUnlocalizedName(itemInfo.netherStarChestplate_UNLOCALIZED_NAME);
	}
	
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister register) {
		itemIcon = register.registerIcon(itemInfo.TEXTURE_LOC + ":" + itemInfo.netherStarChestplate_ICON);
	}
