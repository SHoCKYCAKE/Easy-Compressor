...
public class netherStarLeggings extends ItemArmor{
	...
	public netherStarLeggings(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
		...
		setMaxStackSize(1);
		setUnlocalizedName(itemInfo.netherStarLeggings_UNLOCALIZED_NAME);
	}
	
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister register) {
		itemIcon = register.registerIcon(itemInfo.TEXTURE_LOC + ":" + itemInfo.netherStarLeggings_ICON);
	}
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer){
		return "easycompressor:textures/models/armor/netherStar_layer_2.png";
	}
